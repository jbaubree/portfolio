        ...
        <div class="grid grid-cols-1 md:grid-cols-2 w-full gap-x-10 gap-y-1px">
          <a
            ...
            :class="{
              ...
              'animate-delay-.2s': index === 4,
              'animate-delay-.3s': index === 6,
              'animate-delay-.4s': index === 8,
              'animate-delay-.5s': index === 1,
              'animate-delay-.6s': index === 3,
              'animate-delay-.7s': index === 5,
              'animate-delay-.8s': index === 7,
              'animate-delay-.9s': index === 9,
            }"
          >
            <span
